...
import com.sistemadeliberacion.shared.enums.RoleName;
...
import com.sistemadeliberacion.auth.service.CustomUserDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, AuthenticationProvider authenticationProvider) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/socios/**").hasAnyRole(RoleName.ADMIN.name(), RoleName.SOCIO_COMERCIAL.name())
